        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-tr from-blue-600/20 to-cyan-500/20 rounded-3xl blur-2xl transform rotate-3"></div>
              <div className="bg-[#1f2833] border border-white/10 rounded-3xl p-10 relative z-10 shadow-2xl">
                ...
                <div className="bg-[#0b0c10] rounded-xl p-6 border border-white/5 flex flex-col items-center text-center">
                  ...
                  <a href="tel:8888799161" className="text-3xl font-bold text-cyan-400 hover:text-cyan-300 transition-colors">
                    (888) 879-9161
                  </a>
                </div>
              </div>
