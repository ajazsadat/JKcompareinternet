      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 w-full text-gray-300">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4 leading-relaxed font-light">
            Welcome to jkcompareinternet.online, operated by JKcompareinternet. By accessing or using our website and services, you agree to these Terms of Service. Please read them carefully.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4 leading-relaxed font-light">
            These Terms are governed by and construed in accordance with the laws of the United States and the state in which JKcompareinternet is registered, without regard to conflict of law principles.
          </p>
        </section>
        ...
        <section className="mb-8 pt-8 border-t border-white/10">
          ...
          <ul className="space-y-2 font-light text-gray-400">
            <li className="flex items-center"><span className="text-cyan-400 mr-2">✅</span> (888) 959-4513</li>
            <li className="flex items-center"><span className="text-cyan-400 mr-2">✅</span> 5902 Newfoundland Court, Spring TX 77379</li>
          </ul>
        </section>
