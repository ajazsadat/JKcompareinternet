export const metadata = {
  ...
  description: 'Terms and Conditions for JKcompareinternet online platform.',
};
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 w-full text-gray-300">
        ...
        <section className="mb-8">
          ...
          <p className="mb-4 leading-relaxed font-light">
            Welcome to jkcompareinternet.online, operated by Jari &amp; Kinza Corporation. By accessing or using our website and services, you agree to these Terms of Service. Please read them carefully.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4 leading-relaxed font-light">
            We provide plan comparison information and order facilitation services for cable,
            internet, phone, and mobile services as an independent authorized reseller. Availability
            may vary by service provider and location. All actual service provision, pricing,
            promotions, billing, installation, and customer support are handled directly by the
            underlying service providers. We do not guarantee service availability, pricing, speeds,
        ...
        <section className="mb-8">
          ...
          <p className="mb-4 leading-relaxed font-light">
            All content, logos, text, and trademarks displayed on this site are owned by or licensed to JKcompareinternet or their respective owners. You may not copy, reproduce, or distribute any materials without prior written permission.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4 leading-relaxed font-light">
            You agree to indemnify and hold harmless JKcompareinternet, its affiliates, and partners from any claims, losses, liabilities, or expenses arising from your misuse of the website or violation of these Terms.
          </p>
        </section>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-white mb-4">7. Modification of Terms</h2>
          <p className="mb-4 leading-relaxed font-light">
            We may update these Terms at any time. Changes will be reflected by the "Effective Date" above. Continued use of the website after changes constitutes acceptance of the revised Terms.
          </p>
        </section>
