      ...
      <section className="relative h-[40vh] md:h-[50vh] min-h-[400px] flex items-center justify-center border-b border-white/10 overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto mt-10">
          <p className="text-lg md:text-xl font-semibold text-cyan-300 mb-3 drop-shadow-md">
            Compare Xfinity Internet &amp; Cable Services
          </p>
          <h1 className="text-4xl md:text-6xl font-extrabold text-white mb-6 drop-shadow-lg">
            Compare <span className="text-blue-400">Xfinity</span> internet and cable services With JKcompareinternet
          </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col items-center text-center gap-4">
          ...
          <p className="cta-disclaimer text-sm text-gray-400 max-w-2xl leading-relaxed">
            *JKcompareinternet is an independent resource. We do not sell or manage
            Xfinity accounts; all information is for guidance only.
          </p>
        </div>
      </section>
            ...
            <div key={index} className="bg-[#1f2833] rounded-3xl p-8 border border-white/10 hover:border-blue-500/50 transition-all duration-300 flex flex-col relative overflow-hidden shadow-xl">
              ...
              <div className="mt-8 pt-8 border-t border-white/10 relative z-10">
                ...
                <p className="text-xs text-gray-500 mt-4 text-center">
                  ...
                  independent resource. We do not sell or manage Xfinity accounts; all information
