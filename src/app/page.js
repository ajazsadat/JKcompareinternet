...
export default function Home() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "With our comparison agents, you can review prices, speeds, connection types, contract terms, and promotions from multiple providers easily. We make it simple to find affordable and fast options without visiting multiple websites."
    },
    {
      q: "What types of internet service are available?",
      a: "You may have access to one or more of these internet types: Fiber Internet (High speeds, ideal for streaming and gaming), Cable Internet (Reliable and widely available), DSL Internet (Affordable basic connectivity), and Satellite (Available even in rural areas). We’ll show you what’s available specifically in your ZIP code when you call."
    },
    {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-[#1f2833] rounded-3xl p-8 border border-white/5 hover:border-purple-500/30 transition-all duration-300 hover:shadow-[0_0_30px_rgba(168,85,247,0.15)] flex flex-col h-full relative overflow-hidden group">
              ...
              <p className="text-gray-400 font-light leading-relaxed mb-6 flex-grow">
                Compare mobile plans from participating providers. Review options with data, calling, and coverage features, including 5G availability and flexible plans. JKcompareinternet helps you explore available plans and choose the option that fits your needs based on provider terms & availability.
              </p>
            </div>
          </div>
        </div>
              ...
              <ul className="space-y-6">
                ...
                <li className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="mt-1 text-gray-400 font-light">Not sure which option fits your needs? Our agents can help explain available plans and assist with the enrollment process.</p>
                  </div>
                </li>
              </ul>
            </div>
