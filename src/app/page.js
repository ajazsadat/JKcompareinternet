  ...
  const faqs = [
    {
      ...
      a: "No. JK Compare Internet operates as an independent comparison platform that helps users explore and evaluate Internet and TV plans from multiple trusted providers. We do not directly sel[...]"
    },
    {
    ...
    },
    {
      ...
      a: "Through our comparison tool, you can review prices, speeds, connection types, contract terms, and promotions from multiple providers easily. We make it simple to find affordable and fast [...]
    },
    {
      q: "What types of internet service are available?",
      a: "You may have access to one or more of these internet types: Fiber Internet (High speeds, ideal for streaming and gaming), Cable Internet (Reliable and widely available), DSL Internet (Af[...]"
    },
    {
      q: "Do internet providers offer special promotions or discounts?",
      a: "Yes! Many providers offer introductory pricing, free installation, equipment deals, gift cards, and bundle discounts. We help you review current offers available in your area so you can [...]
    },
    {
    ...
    <div className="flex flex-col min-h-screen bg-[#0b0c10]">
        ...
        <div className="relative z-10 text-center px-4 max-w-5xl mx-auto mt-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              className="inline-flex items-center justify-center text-center px-8 py-4 text-lg font-bold rounded-full text-white bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-500 hove[...]"
            >
              <svg className="w-6 h-6 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth=[...]></svg>
      ...
      <section className="py-24 bg-[#0b0c10] relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Box 1 */}
            <div className="bg-[#1f2833] rounded-3xl p-8 border border-white/5 hover:border-blue-500/30 transition-all duration-300 hover:shadow-[0_0_30px_rgba(6,182,212,0.15)] flex flex-col h-ful[...]">
              ...
              <div className="w-16 h-16 bg-gradient-to-br from-blue-500/20 to-blue-400/20 rounded-2xl flex items-center justify-center mb-6 text-blue-400 border border-blue-500/20 group-hover:scal[...]">
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9.75 17L9 20l-1 1h8l-1-1-.75-[...]" /></svg>
              </div>
              ...
              <p className="text-gray-400 font-light leading-relaxed mb-6 flex-grow">
                Explore TV and streaming plans in one place. Compare packages from participating providers, including options for movies, shows, sports, and live channels. JKcompareinternet guide[...]
              </p>
            </div>

            {/* Box 2 */}
            <div className="bg-[#1f2833] rounded-3xl p-8 border border-white/5 hover:border-blue-500/30 transition-all duration-300 hover:shadow-[0_0_30px_rgba(59,130,246,0.15)] flex flex-col h-f[...]">
              <div className="absolute top-0 right-0 w-32 h-32 bg-blue-500/10 rounded-full blur-2xl transform translate-x-1/2 -translate-y-1/2"></div>
              <div className="w-16 h-16 bg-gradient-to-br from-blue-600/20 to-blue-400/20 rounded-2xl flex items-center justify-center mb-6 text-blue-400 border border-blue-500/20 group-hover:sca[...]">
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 10V3L4 14h7v7l9-11h-7z"></[...]" /></svg>
              </div>
              <h3 className="text-2xl font-bold text-white mb-4">High-Speed Internet</h3>
              <p className="text-gray-400 font-light leading-relaxed mb-6 flex-grow">
                Compare fiber internet plans from participating providers. JKcompareinternet shows you available options for browsing, streaming, gaming, and remote work. We guide you through pla[...]
              </p>
            </div>

            {/* Box 3 */}
            <div className="bg-[#1f2833] rounded-3xl p-8 border border-white/5 hover:border-blue-500/30 transition-all duration-300 hover:shadow-[0_0_30px_rgba(168,85,247,0.15)] flex flex-col h-f[...]">
              <div className="absolute top-0 right-0 w-32 h-32 bg-blue-500/10 rounded-full blur-2xl transform translate-x-1/2 -translate-y-1/2"></div>
              <div className="w-16 h-16 bg-gradient-to-br from-blue-500/20 to-blue-400/20 rounded-2xl flex items-center justify-center mb-6 text-blue-400 border border-blue-500/20 group-hover:sca[...]">
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 18h.01M8 21h8a2 2 0 002-2V[...]" /></svg>
              </div>
              <h3 className="text-2xl font-bold text-white mb-4">All-in-One Mobile</h3>
              <p className="text-gray-400 font-light leading-relaxed mb-6 flex-grow">
                Compare mobile plans from participating providers. Review options with data, calling, and coverage features, including 5G availability and flexible plans. JKcompareinternet helps [...]
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            ...
            <div className="w-full lg:w-1/2">
              ...
              <p className="text-gray-300 text-lg mb-10 font-light leading-relaxed">
                Looking for TV and internet options in your area? Compare plans from participating providers and explore available offers based on your location. JKcompareinternet can help guide [...]
              </p>
            ...
            <div className="w-full lg:w-1/2">
              <div className="bg-[#1f2833] rounded-3xl p-10 border border-white/10 shadow-2xl relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <a
                    href="tel:(888) 879-9161"
                    className="flex items-center justify-center text-center w-full px-8 py-5 text-xl font-bold rounded-xl text-white bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-500[...]"
                  >
                    <svg className="w-6 h-6 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28[...]" /></svg>
                    Compare & Call (888) 879-9161
                  </a>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-400 text-sm md:text-base leading-relaxed max-w-4xl mt-4">JKcompareinternet is an authorized reseller through Sandler Partners, LLC, connecting customers with select providers, including Xfinity.</p>
        </div>
      </section>
    </div>
  );
