...
export default function IndependentSupportHelpContent({ className = '' }) {
  return (
    <div
      className={`min-h-screen w-full bg-[#f4f1fb] bg-cover bg-center bg-no-repeat px-3 py-8 sm:px-4 sm:py-10 ${className}`}
      style={{
    ...
    >
      <div className="mx-auto flex w-full max-w-6xl flex-col items-center">
        ...
        <div className="mt-6 flex w-full flex-col items-center px-2 md:mt-8">
          <Link
            href="/"
            className="text-center text-[22px] font-bold tracking-tight text-[#5A23B9] no-underline sm:text-[28px] md:text-[32px]"
            style={{ fontFamily: 'var(--font-support-poppins), Poppins, sans-serif' }}
          >
            JKcompareinternet
          </Link>
        </div>
