    ...
    >
      ...
      <div className="mx-auto flex w-full max-w-[1340px] flex-1 flex-col px-2.5 pb-[18px] pt-2 md:py-[30px]">
        ...
        <div className="mt-6 flex w-full justify-center md:mt-4">
          {/* The site brand is a wordmark, not an image; solid dark keeps it legible here. */}
          <Link
            href="/"
            className="font-poppins text-[22px] font-bold tracking-tight text-[#101828] md:text-[28px]"
          >
            {SITE.brandFull}
          </Link>
        </div>
